...
int main(int argc, char *argv[]) {
  ...
  matrizvector(blocks_per_process * blk, n, B, x, y_local);

  /* Hay que crear otro tipo de dato MPI para recoger al vector resultado */
  MPI_Datatype blocktype_y;
  MPI_Type_contiguous(blocks_per_process * blk, MPI_DOUBLE, &blocktype_y);
